...
const Graphic = ({ data, name }) => {
    ...
    svg.selectAll('circle')
      ...
      .on('mouseover', (event, d, i) => {
        ...
        const tooltipGroup = svg.append('g')
          .attr('id', 'tooltip')
          .attr('transform', `translate(${x(d.valueDate)}, ${y(d.value) - 15})`);
  ...
  }, [data, name]); // Зависимость от data и title для обновления графика при изменении данных и заголовка
