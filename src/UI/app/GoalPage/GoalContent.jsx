      ...
      <div className={classes.header}>
        ...
        <div className={classes.editText}>
          ...
          <div className={classes.four}>
            <div>
              <span>Цели компании "name"</span>
            </div>
          </div>
          <img src={Blacksavetmp} alt="Blacksavetmp" className={classes.image}/>
